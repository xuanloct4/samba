...
static void ndr_print_flags_PERF_COUNTER_DEFINITION(struct ndr_print *ndr, const char *name, int unused, const struct PERF_COUNTER_DEFINITION *r)
{
...
static void ndr_print_flags_PERF_COUNTER_BLOCK(struct ndr_print *ndr, const char *name, int unused, const struct PERF_COUNTER_BLOCK *r)
{
...
static void ndr_print_flags_PERF_INSTANCE_DEFINITION(struct ndr_print *ndr, const char *name, int unused, const struct PERF_INSTANCE_DEFINITION *r)
{
...
static void ndr_print_flags_PERF_OBJECT_TYPE(struct ndr_print *ndr, const char *name, int unused, const struct PERF_OBJECT_TYPE *r)
{
...
static void ndr_print_flags_PERF_DATA_BLOCK(struct ndr_print *ndr, const char *name, int unused, const struct PERF_DATA_BLOCK *r)
{
