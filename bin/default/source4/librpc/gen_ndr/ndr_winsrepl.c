...
static void ndr_print_flags_wrepl_packet(struct ndr_print *ndr, const char *name, int unused, const struct wrepl_packet *r)
{
...
static void ndr_print_flags_wrepl_wrap(struct ndr_print *ndr, const char *name, int unused, const struct wrepl_wrap *r)
{
