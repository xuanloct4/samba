...
static void ndr_print_flags_negoex_AUTH_SCHEME(struct ndr_print *ndr, const char *name, int unused, const struct negoex_AUTH_SCHEME *r)
{
...
static void ndr_print_flags_negoex_EXTENSION(struct ndr_print *ndr, const char *name, int unused, const struct negoex_EXTENSION *r)
{
...
static void ndr_print_flags_negoex_ALERT_PULSE(struct ndr_print *ndr, const char *name, int unused, const struct negoex_ALERT_PULSE *r)
{
...
static void ndr_print_flags_negoex_ALERT(struct ndr_print *ndr, const char *name, int unused, const struct negoex_ALERT *r)
{
...
static void ndr_print_flags_negoex_MESSAGE(struct ndr_print *ndr, const char *name, int unused, const struct negoex_MESSAGE *r)
{
...
static void ndr_print_flags_negoex_MESSAGE_ARRAY(struct ndr_print *ndr, const char *name, int unused, const struct negoex_MESSAGE_ARRAY *r)
{
