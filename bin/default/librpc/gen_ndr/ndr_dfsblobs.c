...
static void ndr_print_flags_dfs_referral_resp(struct ndr_print *ndr, const char *name, int unused, const struct dfs_referral_resp *r)
{
...
static void ndr_print_flags_dfs_GetDFSReferral_in(struct ndr_print *ndr, const char *name, int unused, const struct dfs_GetDFSReferral_in *r)
{
