...
static void ndr_print_flags_fsrvp_state_smap(struct ndr_print *ndr, const char *name, int unused, const struct fsrvp_state_smap *r)
{
...
static void ndr_print_flags_fsrvp_state_sc(struct ndr_print *ndr, const char *name, int unused, const struct fsrvp_state_sc *r)
{
...
static void ndr_print_flags_fsrvp_state_sc_set(struct ndr_print *ndr, const char *name, int unused, const struct fsrvp_state_sc_set *r)
{
