...
static void ndr_print_flags_ntprinting_form(struct ndr_print *ndr, const char *name, int unused, const struct ntprinting_form *r)
{
...
static void ndr_print_flags_ntprinting_driver(struct ndr_print *ndr, const char *name, int unused, const struct ntprinting_driver *r)
{
...
static void ndr_print_flags_ntprinting_devicemode(struct ndr_print *ndr, const char *name, int unused, const struct ntprinting_devicemode *r)
{
...
static void ndr_print_flags_ntprinting_printer_data(struct ndr_print *ndr, const char *name, int unused, const struct ntprinting_printer_data *r)
{
...
static void ndr_print_flags_ntprinting_printer_info(struct ndr_print *ndr, const char *name, int unused, const struct ntprinting_printer_info *r)
{
...
static void ndr_print_flags_ntprinting_printer(struct ndr_print *ndr, const char *name, int unused, const struct ntprinting_printer *r)
{
