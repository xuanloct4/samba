...
static bool api_Opnum148NotUsedOnWire(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_OPNUM148NOTUSEDONWIRE];

	r = talloc(talloc_tos(), struct Opnum148NotUsedOnWire);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum148NotUsedOnWire, NDR_IN, r);
	}

	r->out.result = _Opnum148NotUsedOnWire(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum148NotUsedOnWire, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_Opnum149otUsedOnWire(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_OPNUM149OTUSEDONWIRE];

	r = talloc(talloc_tos(), struct Opnum149otUsedOnWire);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum149otUsedOnWire, NDR_IN, r);
	}

	r->out.result = _Opnum149otUsedOnWire(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum149otUsedOnWire, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_Opnum150NotUsedOnWire(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_OPNUM150NOTUSEDONWIRE];

	r = talloc(talloc_tos(), struct Opnum150NotUsedOnWire);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum150NotUsedOnWire, NDR_IN, r);
	}

	r->out.result = _Opnum150NotUsedOnWire(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum150NotUsedOnWire, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_Opnum151NotUsedOnWire(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_OPNUM151NOTUSEDONWIRE];

	r = talloc(talloc_tos(), struct Opnum151NotUsedOnWire);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum151NotUsedOnWire, NDR_IN, r);
	}

	r->out.result = _Opnum151NotUsedOnWire(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum151NotUsedOnWire, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_Opnum152NotUsedOnWire(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_OPNUM152NOTUSEDONWIRE];

	r = talloc(talloc_tos(), struct Opnum152NotUsedOnWire);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum152NotUsedOnWire, NDR_IN, r);
	}

	r->out.result = _Opnum152NotUsedOnWire(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum152NotUsedOnWire, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_Opnum153NotUsedOnWire(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_OPNUM153NOTUSEDONWIRE];

	r = talloc(talloc_tos(), struct Opnum153NotUsedOnWire);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum153NotUsedOnWire, NDR_IN, r);
	}

	r->out.result = _Opnum153NotUsedOnWire(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum153NotUsedOnWire, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_Opnum154NotUsedOnWire(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_OPNUM154NOTUSEDONWIRE];

	r = talloc(talloc_tos(), struct Opnum154NotUsedOnWire);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum154NotUsedOnWire, NDR_IN, r);
	}

	r->out.result = _Opnum154NotUsedOnWire(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum154NotUsedOnWire, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_AddNotifyResourceTypeV2(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_ADDNOTIFYRESOURCETYPEV2];

	r = talloc(talloc_tos(), struct clusapi_AddNotifyResourceTypeV2);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_AddNotifyResourceTypeV2, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_AddNotifyResourceTypeV2(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_AddNotifyResourceTypeV2, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_Opnum156NotUsedOnWire(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_OPNUM156NOTUSEDONWIRE];

	r = talloc(talloc_tos(), struct Opnum156NotUsedOnWire);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum156NotUsedOnWire, NDR_IN, r);
	}

	r->out.result = _Opnum156NotUsedOnWire(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum156NotUsedOnWire, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_ExecuteReadBatchEx(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_EXECUTEREADBATCHEX];

	r = talloc(talloc_tos(), struct clusapi_ExecuteReadBatchEx);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_ExecuteReadBatchEx, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_ExecuteReadBatchEx(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_ExecuteReadBatchEx, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_Opnum158NotUsedOnWire(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_OPNUM158NOTUSEDONWIRE];

	r = talloc(talloc_tos(), struct Opnum158NotUsedOnWire);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum158NotUsedOnWire, NDR_IN, r);
	}

	r->out.result = _Opnum158NotUsedOnWire(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum158NotUsedOnWire, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_Opnum159NotUsedOnWire(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_OPNUM159NOTUSEDONWIRE];

	r = talloc(talloc_tos(), struct Opnum159NotUsedOnWire);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum159NotUsedOnWire, NDR_IN, r);
	}

	r->out.result = _Opnum159NotUsedOnWire(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum159NotUsedOnWire, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_Opnum160NotUsedOnWire(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_OPNUM160NOTUSEDONWIRE];

	r = talloc(talloc_tos(), struct Opnum160NotUsedOnWire);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum160NotUsedOnWire, NDR_IN, r);
	}

	r->out.result = _Opnum160NotUsedOnWire(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum160NotUsedOnWire, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_Opnum161NotUsedOnWire(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_OPNUM161NOTUSEDONWIRE];

	r = talloc(talloc_tos(), struct Opnum161NotUsedOnWire);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum161NotUsedOnWire, NDR_IN, r);
	}

	r->out.result = _Opnum161NotUsedOnWire(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum161NotUsedOnWire, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_Opnum162NotUsedOnWire(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_OPNUM162NOTUSEDONWIRE];

	r = talloc(talloc_tos(), struct Opnum162NotUsedOnWire);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum162NotUsedOnWire, NDR_IN, r);
	}

	r->out.result = _Opnum162NotUsedOnWire(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum162NotUsedOnWire, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_CreateGroupSet(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_CREATEGROUPSET];

	r = talloc(talloc_tos(), struct clusapi_CreateGroupSet);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_CreateGroupSet, NDR_IN, r);
	}
	...
	r->out.hGroupSet = talloc_zero(r, struct policy_handle);
	if (r->out.hGroupSet == NULL) {
		talloc_free(r);
		return false;
	}

	_clusapi_CreateGroupSet(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_CreateGroupSet, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_OpenGroupSet(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_OPENGROUPSET];

	r = talloc(talloc_tos(), struct clusapi_OpenGroupSet);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_OpenGroupSet, NDR_IN, r);
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_OpenGroupSet, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_CloseGroupSet(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_CLOSEGROUPSET];

	r = talloc(talloc_tos(), struct clusapi_CloseGroupSet);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_CloseGroupSet, NDR_IN, r);
	}

	NDR_ZERO_STRUCT(r->out);
	r->out.GroupSet = r->in.GroupSet;
	r->out.result = _clusapi_CloseGroupSet(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_CloseGroupSet, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_DeleteGroupSet(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_DeleteGroupSet *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_DELETEGROUPSET];

	r = talloc(talloc_tos(), struct clusapi_DeleteGroupSet);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_DeleteGroupSet, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_DeleteGroupSet(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_DeleteGroupSet, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_AddGroupToGroupSet(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_AddGroupToGroupSet *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_ADDGROUPTOGROUPSET];

	r = talloc(talloc_tos(), struct clusapi_AddGroupToGroupSet);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_AddGroupToGroupSet, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_AddGroupToGroupSet(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_AddGroupToGroupSet, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_RemoveGroupFromGroupSet(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_RemoveGroupFromGroupSet *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_REMOVEGROUPFROMGROUPSET];

	r = talloc(talloc_tos(), struct clusapi_RemoveGroupFromGroupSet);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_RemoveGroupFromGroupSet, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_RemoveGroupFromGroupSet(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_RemoveGroupFromGroupSet, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_MoveGroupToGroupSet(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_MoveGroupToGroupSet *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_MOVEGROUPTOGROUPSET];

	r = talloc(talloc_tos(), struct clusapi_MoveGroupToGroupSet);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_MoveGroupToGroupSet, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_MoveGroupToGroupSet(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_MoveGroupToGroupSet, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_Opnum170NotUsedOnWire(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct Opnum170NotUsedOnWire *r;

	call = &ndr_table_clusapi.calls[NDR_OPNUM170NOTUSEDONWIRE];

	r = talloc(talloc_tos(), struct Opnum170NotUsedOnWire);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum170NotUsedOnWire, NDR_IN, r);
	}

	r->out.result = _Opnum170NotUsedOnWire(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(Opnum170NotUsedOnWire, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_AddGroupSetDependency(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_AddGroupSetDependency *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_ADDGROUPSETDEPENDENCY];

	r = talloc(talloc_tos(), struct clusapi_AddGroupSetDependency);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_AddGroupSetDependency, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_AddGroupSetDependency(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_AddGroupSetDependency, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_AddGroupToGroupSetDependency(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_AddGroupToGroupSetDependency *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_ADDGROUPTOGROUPSETDEPENDENCY];

	r = talloc(talloc_tos(), struct clusapi_AddGroupToGroupSetDependency);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_AddGroupToGroupSetDependency, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_AddGroupToGroupSetDependency(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_AddGroupToGroupSetDependency, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_NodeGroupSetControl(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_NodeGroupSetControl *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_NODEGROUPSETCONTROL];

	r = talloc(talloc_tos(), struct clusapi_NodeGroupSetControl);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_NodeGroupSetControl, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_NodeGroupSetControl(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_NodeGroupSetControl, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_GroupSetControl(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_GroupSetControl *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_GROUPSETCONTROL];

	r = talloc(talloc_tos(), struct clusapi_GroupSetControl);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_GroupSetControl, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_GroupSetControl(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_GroupSetControl, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_SetGroupDependencyExpression(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_SetGroupDependencyExpression *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_SETGROUPDEPENDENCYEXPRESSION];

	r = talloc(talloc_tos(), struct clusapi_SetGroupDependencyExpression);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_SetGroupDependencyExpression, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_SetGroupDependencyExpression(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_SetGroupDependencyExpression, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_RemoveClusterGroupDependency(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_RemoveClusterGroupDependency *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_REMOVECLUSTERGROUPDEPENDENCY];

	r = talloc(talloc_tos(), struct clusapi_RemoveClusterGroupDependency);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_RemoveClusterGroupDependency, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_RemoveClusterGroupDependency(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_RemoveClusterGroupDependency, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_SetGroupSetDependencyExpression(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_SetGroupSetDependencyExpression *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_SETGROUPSETDEPENDENCYEXPRESSION];

	r = talloc(talloc_tos(), struct clusapi_SetGroupSetDependencyExpression);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_SetGroupSetDependencyExpression, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_SetGroupSetDependencyExpression(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_SetGroupSetDependencyExpression, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_RemoveGroupSetDependency(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_RemoveGroupSetDependency *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_REMOVEGROUPSETDEPENDENCY];

	r = talloc(talloc_tos(), struct clusapi_RemoveGroupSetDependency);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_RemoveGroupSetDependency, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_RemoveGroupSetDependency(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_RemoveGroupSetDependency, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_RemoveClusterGroupToGroupSetDependency(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_RemoveClusterGroupToGroupSetDependency *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_REMOVECLUSTERGROUPTOGROUPSETDEPENDENCY];

	r = talloc(talloc_tos(), struct clusapi_RemoveClusterGroupToGroupSetDependency);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_RemoveClusterGroupToGroupSetDependency, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_RemoveClusterGroupToGroupSetDependency(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_RemoveClusterGroupToGroupSetDependency, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_CreateGroupSetEnum(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_CREATEGROUPSETENUM];

	r = talloc(talloc_tos(), struct clusapi_CreateGroupSetEnum);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_CreateGroupSetEnum, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_CreateGroupSetEnum(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_CreateGroupSetEnum, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_CreateNetInterfaceEnum(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_CreateNetInterfaceEnum *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_CREATENETINTERFACEENUM];

	r = talloc(talloc_tos(), struct clusapi_CreateNetInterfaceEnum);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_CreateNetInterfaceEnum, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_CreateNetInterfaceEnum(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_CreateNetInterfaceEnum, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_ChangeCsvStateEx(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_ChangeCsvStateEx *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_CHANGECSVSTATEEX];

	r = talloc(talloc_tos(), struct clusapi_ChangeCsvStateEx);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_ChangeCsvStateEx, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_ChangeCsvStateEx(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_ChangeCsvStateEx, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_clusapi_AddGroupToGroupSetEx(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	enum ndr_err_code ndr_err;
	struct clusapi_AddGroupToGroupSetEx *r;

	call = &ndr_table_clusapi.calls[NDR_CLUSAPI_ADDGROUPTOGROUPSETEX];

	r = talloc(talloc_tos(), struct clusapi_AddGroupToGroupSetEx);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_AddGroupToGroupSetEx, NDR_IN, r);
	}
	...
	r->out.result = _clusapi_AddGroupToGroupSetEx(p, r);
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(clusapi_AddGroupToGroupSetEx, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static const struct api_struct api_clusapi_cmds[] = 
{
	...
	{"OPNUM148NOTUSEDONWIRE", NDR_OPNUM148NOTUSEDONWIRE, api_Opnum148NotUsedOnWire},
	{"OPNUM149OTUSEDONWIRE", NDR_OPNUM149OTUSEDONWIRE, api_Opnum149otUsedOnWire},
	{"OPNUM150NOTUSEDONWIRE", NDR_OPNUM150NOTUSEDONWIRE, api_Opnum150NotUsedOnWire},
	{"OPNUM151NOTUSEDONWIRE", NDR_OPNUM151NOTUSEDONWIRE, api_Opnum151NotUsedOnWire},
	{"OPNUM152NOTUSEDONWIRE", NDR_OPNUM152NOTUSEDONWIRE, api_Opnum152NotUsedOnWire},
	{"OPNUM153NOTUSEDONWIRE", NDR_OPNUM153NOTUSEDONWIRE, api_Opnum153NotUsedOnWire},
	{"OPNUM154NOTUSEDONWIRE", NDR_OPNUM154NOTUSEDONWIRE, api_Opnum154NotUsedOnWire},
	{"CLUSAPI_ADDNOTIFYRESOURCETYPEV2", NDR_CLUSAPI_ADDNOTIFYRESOURCETYPEV2, api_clusapi_AddNotifyResourceTypeV2},
	{"OPNUM156NOTUSEDONWIRE", NDR_OPNUM156NOTUSEDONWIRE, api_Opnum156NotUsedOnWire},
	{"CLUSAPI_EXECUTEREADBATCHEX", NDR_CLUSAPI_EXECUTEREADBATCHEX, api_clusapi_ExecuteReadBatchEx},
	{"OPNUM158NOTUSEDONWIRE", NDR_OPNUM158NOTUSEDONWIRE, api_Opnum158NotUsedOnWire},
	{"OPNUM159NOTUSEDONWIRE", NDR_OPNUM159NOTUSEDONWIRE, api_Opnum159NotUsedOnWire},
	{"OPNUM160NOTUSEDONWIRE", NDR_OPNUM160NOTUSEDONWIRE, api_Opnum160NotUsedOnWire},
	{"OPNUM161NOTUSEDONWIRE", NDR_OPNUM161NOTUSEDONWIRE, api_Opnum161NotUsedOnWire},
	{"OPNUM162NOTUSEDONWIRE", NDR_OPNUM162NOTUSEDONWIRE, api_Opnum162NotUsedOnWire},
	{"CLUSAPI_CREATEGROUPSET", NDR_CLUSAPI_CREATEGROUPSET, api_clusapi_CreateGroupSet},
	{"CLUSAPI_OPENGROUPSET", NDR_CLUSAPI_OPENGROUPSET, api_clusapi_OpenGroupSet},
	{"CLUSAPI_CLOSEGROUPSET", NDR_CLUSAPI_CLOSEGROUPSET, api_clusapi_CloseGroupSet},
	{"CLUSAPI_DELETEGROUPSET", NDR_CLUSAPI_DELETEGROUPSET, api_clusapi_DeleteGroupSet},
	{"CLUSAPI_ADDGROUPTOGROUPSET", NDR_CLUSAPI_ADDGROUPTOGROUPSET, api_clusapi_AddGroupToGroupSet},
	{"CLUSAPI_REMOVEGROUPFROMGROUPSET", NDR_CLUSAPI_REMOVEGROUPFROMGROUPSET, api_clusapi_RemoveGroupFromGroupSet},
	{"CLUSAPI_MOVEGROUPTOGROUPSET", NDR_CLUSAPI_MOVEGROUPTOGROUPSET, api_clusapi_MoveGroupToGroupSet},
	{"OPNUM170NOTUSEDONWIRE", NDR_OPNUM170NOTUSEDONWIRE, api_Opnum170NotUsedOnWire},
	{"CLUSAPI_ADDGROUPSETDEPENDENCY", NDR_CLUSAPI_ADDGROUPSETDEPENDENCY, api_clusapi_AddGroupSetDependency},
	{"CLUSAPI_ADDGROUPTOGROUPSETDEPENDENCY", NDR_CLUSAPI_ADDGROUPTOGROUPSETDEPENDENCY, api_clusapi_AddGroupToGroupSetDependency},
	{"CLUSAPI_NODEGROUPSETCONTROL", NDR_CLUSAPI_NODEGROUPSETCONTROL, api_clusapi_NodeGroupSetControl},
	{"CLUSAPI_GROUPSETCONTROL", NDR_CLUSAPI_GROUPSETCONTROL, api_clusapi_GroupSetControl},
	{"CLUSAPI_SETGROUPDEPENDENCYEXPRESSION", NDR_CLUSAPI_SETGROUPDEPENDENCYEXPRESSION, api_clusapi_SetGroupDependencyExpression},
	{"CLUSAPI_REMOVECLUSTERGROUPDEPENDENCY", NDR_CLUSAPI_REMOVECLUSTERGROUPDEPENDENCY, api_clusapi_RemoveClusterGroupDependency},
	{"CLUSAPI_SETGROUPSETDEPENDENCYEXPRESSION", NDR_CLUSAPI_SETGROUPSETDEPENDENCYEXPRESSION, api_clusapi_SetGroupSetDependencyExpression},
	{"CLUSAPI_REMOVEGROUPSETDEPENDENCY", NDR_CLUSAPI_REMOVEGROUPSETDEPENDENCY, api_clusapi_RemoveGroupSetDependency},
	{"CLUSAPI_REMOVECLUSTERGROUPTOGROUPSETDEPENDENCY", NDR_CLUSAPI_REMOVECLUSTERGROUPTOGROUPSETDEPENDENCY, api_clusapi_RemoveClusterGroupToGroupSetDependency},
	{"CLUSAPI_CREATEGROUPSETENUM", NDR_CLUSAPI_CREATEGROUPSETENUM, api_clusapi_CreateGroupSetEnum},
	{"CLUSAPI_CREATENETINTERFACEENUM", NDR_CLUSAPI_CREATENETINTERFACEENUM, api_clusapi_CreateNetInterfaceEnum},
	{"CLUSAPI_CHANGECSVSTATEEX", NDR_CLUSAPI_CHANGECSVSTATEEX, api_clusapi_ChangeCsvStateEx},
	{"CLUSAPI_ADDGROUPTOGROUPSETEX", NDR_CLUSAPI_ADDGROUPTOGROUPSETEX, api_clusapi_AddGroupToGroupSetEx},
};
