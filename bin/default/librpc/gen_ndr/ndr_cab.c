...
static void ndr_print_flags_CFHEADER(struct ndr_print *ndr, const char *name, int unused, const struct CFHEADER *r)
{
...
static void ndr_print_flags_CFFOLDER(struct ndr_print *ndr, const char *name, int unused, const struct CFFOLDER *r)
{
...
static void ndr_print_flags_CFFILE(struct ndr_print *ndr, const char *name, int unused, const struct CFFILE *r)
{
...
static void ndr_print_flags_cab_file(struct ndr_print *ndr, const char *name, int unused, const struct cab_file *r)
{
