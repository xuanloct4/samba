...
static void ndr_print_flags_rap_PrintQueue3(struct ndr_print *ndr, const char *name, int unused, const struct rap_PrintQueue3 *r)
{
...
static void ndr_print_flags_rap_LogonHours(struct ndr_print *ndr, const char *name, int unused, const struct rap_LogonHours *r)
{
...
static void ndr_print_flags_rap_TimeOfDayInfo(struct ndr_print *ndr, const char *name, int unused, const struct rap_TimeOfDayInfo *r)
{
