...
static void ndr_print_flags_smb2_lease_key(struct ndr_print *ndr, const char *name, int unused, const struct smb2_lease_key *r)
{
...
static void ndr_print_flags_smb2_lease(struct ndr_print *ndr, const char *name, int unused, const struct smb2_lease *r)
{
