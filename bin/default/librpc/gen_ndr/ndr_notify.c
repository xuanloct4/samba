...
static void ndr_print_flags_notify_remote_event(struct ndr_print *ndr, const char *name, int unused, const struct notify_remote_event *r)
{
	ndr_print_notify_remote_event(ndr, name, r);
}
...
static const struct ndr_interface_public_struct notify_public_structs[] = {
	...
	{
		.name = "notify_remote_event",
		.struct_size = sizeof(struct notify_remote_event ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_notify_remote_event,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_notify_remote_event,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_notify_remote_event,
	},
	{
