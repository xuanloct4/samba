...
void ndr_print_Opnum148NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct Opnum148NotUsedOnWire *r);
void ndr_print_Opnum149otUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct Opnum149otUsedOnWire *r);
void ndr_print_Opnum150NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct Opnum150NotUsedOnWire *r);
void ndr_print_Opnum151NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct Opnum151NotUsedOnWire *r);
void ndr_print_Opnum152NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct Opnum152NotUsedOnWire *r);
void ndr_print_Opnum153NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct Opnum153NotUsedOnWire *r);
void ndr_print_Opnum154NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct Opnum154NotUsedOnWire *r);
void ndr_print_clusapi_AddNotifyResourceTypeV2(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_AddNotifyResourceTypeV2 *r);
void ndr_print_Opnum156NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct Opnum156NotUsedOnWire *r);
void ndr_print_clusapi_ExecuteReadBatchEx(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_ExecuteReadBatchEx *r);
void ndr_print_Opnum158NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct Opnum158NotUsedOnWire *r);
void ndr_print_Opnum159NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct Opnum159NotUsedOnWire *r);
void ndr_print_Opnum160NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct Opnum160NotUsedOnWire *r);
void ndr_print_Opnum161NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct Opnum161NotUsedOnWire *r);
void ndr_print_Opnum162NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct Opnum162NotUsedOnWire *r);
void ndr_print_clusapi_CreateGroupSet(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_CreateGroupSet *r);
void ndr_print_clusapi_OpenGroupSet(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_OpenGroupSet *r);
void ndr_print_clusapi_CloseGroupSet(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_CloseGroupSet *r);
void ndr_print_clusapi_DeleteGroupSet(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_DeleteGroupSet *r);
void ndr_print_clusapi_AddGroupToGroupSet(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_AddGroupToGroupSet *r);
void ndr_print_clusapi_RemoveGroupFromGroupSet(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_RemoveGroupFromGroupSet *r);
void ndr_print_clusapi_MoveGroupToGroupSet(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_MoveGroupToGroupSet *r);
void ndr_print_Opnum170NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct Opnum170NotUsedOnWire *r);
void ndr_print_clusapi_AddGroupSetDependency(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_AddGroupSetDependency *r);
void ndr_print_clusapi_AddGroupToGroupSetDependency(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_AddGroupToGroupSetDependency *r);
void ndr_print_clusapi_NodeGroupSetControl(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_NodeGroupSetControl *r);
void ndr_print_clusapi_GroupSetControl(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_GroupSetControl *r);
void ndr_print_clusapi_SetGroupDependencyExpression(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_SetGroupDependencyExpression *r);
void ndr_print_clusapi_RemoveClusterGroupDependency(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_RemoveClusterGroupDependency *r);
void ndr_print_clusapi_SetGroupSetDependencyExpression(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_SetGroupSetDependencyExpression *r);
void ndr_print_clusapi_RemoveGroupSetDependency(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_RemoveGroupSetDependency *r);
void ndr_print_clusapi_RemoveClusterGroupToGroupSetDependency(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_RemoveClusterGroupToGroupSetDependency *r);
void ndr_print_clusapi_CreateGroupSetEnum(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_CreateGroupSetEnum *r);
void ndr_print_clusapi_CreateNetInterfaceEnum(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_CreateNetInterfaceEnum *r);
void ndr_print_clusapi_ChangeCsvStateEx(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_ChangeCsvStateEx *r);
void ndr_print_clusapi_AddGroupToGroupSetEx(struct ndr_print *ndr, const char *name, int flags, const struct clusapi_AddGroupToGroupSetEx *r);
