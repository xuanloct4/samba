...
enum ndr_err_code ndr_push__spoolss_EnumPerMachineConnections(struct ndr_push *ndr, int flags, const struct _spoolss_EnumPerMachineConnections *r);
enum ndr_err_code ndr_pull__spoolss_EnumPerMachineConnections(struct ndr_pull *ndr, int flags, struct _spoolss_EnumPerMachineConnections *r);
void ndr_print__spoolss_EnumPerMachineConnections(struct ndr_print *ndr, const char *name, int flags, const struct _spoolss_EnumPerMachineConnections *r);
enum ndr_err_code ndr_push___spoolss_EnumPerMachineConnections(struct ndr_push *ndr, int flags, const struct __spoolss_EnumPerMachineConnections *r);
enum ndr_err_code ndr_pull___spoolss_EnumPerMachineConnections(struct ndr_pull *ndr, int flags, struct __spoolss_EnumPerMachineConnections *r);
void ndr_print___spoolss_EnumPerMachineConnections(struct ndr_print *ndr, const char *name, int flags, const struct __spoolss_EnumPerMachineConnections *r);
