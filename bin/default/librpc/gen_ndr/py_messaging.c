...
MODULE_INIT_FUNC(messaging)
{
	...
	PyModule_AddObject(m, "MSG_WINBIND_TRY_TO_GO_ONLINE", PyLong_FromUnsignedLongLong((uint32_t)MSG_WINBIND_TRY_TO_GO_ONLINE));
	PyModule_AddObject(m, "MSG_WINBIND_FAILED_TO_GO_ONLINE", PyLong_FromUnsignedLongLong((uint32_t)MSG_WINBIND_FAILED_TO_GO_ONLINE));
